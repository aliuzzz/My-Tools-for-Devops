...
用法：
    python cmcc_cdn_spider_v4.1.py                    # 默认跑第一个客户
    python cmcc_cdn_spider_v4.1.py --list             # 列出所有客户
    python cmcc_cdn_spider_v4.1.py --customer "淮北移动"  # 指定客户
...
def run_spider(cfg, debug=False):
    ...
    Args:
        debug: True 时弹出浏览器窗口（不启用 headless），方便肉眼观察操作
    """
...
def main():
    parser = argparse.ArgumentParser(description='CDN带宽采样推送脚本 v4.1')
