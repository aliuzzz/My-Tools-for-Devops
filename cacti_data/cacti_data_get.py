...
class CactiData:
    ...
    def run(self):
        ...
        for item in custom_data:
            ...
            row = {
                ...
                '昨日95值(M)': yesterday_data.get('nfValue'),
                '昨日是否打峰': is_peak,
    ...
    def read_custom_csv(self):
        custom_data = []
        with open('cacti_data\\custom.csv', 'r', encoding='utf-8') as csvfile:
    ...
    def write_to_csv(data: list):
        ...
        file_name = 'daily_cacti_data.csv'
